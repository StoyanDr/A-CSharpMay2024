...
public class StartUp
{
    static void Main(string[] args)
    {
        ...
        RealEstate warehouse = new RealEstate("789 Industrial Ave", "10111", 750000.0m,
        ...
        RealEstate villa = new RealEstate("987 Luxury Ln", "16171", 1000000.0m, 600.0); estateAgency.AddRealEstate(villa); 
        // Should not add as capacity is full 
        // Get Count
        Console.WriteLine(estateAgency.Count); 
        // 5 
        // Remove RealEstate
        Console.WriteLine(estateAgency.RemoveRealEstate("987 Luxury Ln")); 
        // False
        Console.WriteLine(estateAgency.RemoveRealEstate("123 Main St")); 
        // True 
        // GetRealEstate
